...
WebSocket RAT is a highly secure Remote Access Trojan based on Javalin structured as a multi-module Maven project. It can remotely control both Linux and Windows computers and has persistence support.
